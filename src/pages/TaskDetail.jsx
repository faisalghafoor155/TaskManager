        ...
        <div className="w-full space-y-0">
          {activity?.map((item, index) => (
            <Card
              key={item.id}
              item={item}
              isConnected={index < activity?.length - 1} //WHAT IS THIS FOR ?
            />
          ))}
        </div>
      </div>
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                  {task?.assets?.map((el, index) => (
                    <img
                      ...
                      src={el}
                      alt={index}
                      className="w-full rounded h-auto md:h-44 2xl:h-52 cursor-pointer transition-all duration-700 md:hover:scale-110 hover:z-50"
                    />
                  ))}
                </div>
              </div>
